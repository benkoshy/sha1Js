...
class sha1Calc {
  ...
  processFile(file) {
    ...
    output.push('<tr>', '<td>SHA-1 (Fingerprint) </td><td> <div class="progress" style="margin-bottom: 0px" id="sha1_file_hash_', this.file_id, '"><div class="progress-bar progress-bar-striped bar" style="width: 2%;"></div></div></td></tr>');
